		...
		"outputs": [
			{
				"components": [
					...
					{
						"internalType": "enum YieldMaxCCIP.ErrorCode",
						"name": "errorCode",
						"type": "uint8"
					}
				],
				"internalType": "struct YieldMaxCCIP.FailedMessage[]",
				"name": "",
				"type": "tuple[]"
			}
		],
